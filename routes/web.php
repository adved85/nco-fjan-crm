...
Route::group(["middleware" => "auth"], function () {
    ...
    Route::get('resivedreferals', 'NonMedicalReferralController@resivedindex')->name('resivedreferals');
    Route::get('sendreferals', 'NonMedicalReferralController@sendindex')->name('sendreferals');
...
Route::post('searchtable', 'SearchTableController@searchid')->name('searchtableid');
Route::post('searchtablename', 'SearchTableController@searchname')->name('searchtablename');
Route::post('searchtablelname', 'SearchTableController@searchlname')->name('searchtablelname');
Route::post('searchtableuname', 'SearchTableController@searchuname')->name('searchtableuname');
Route::post('searchtabledep', 'SearchTableController@searchdep')->name('searchtabledep');
Route::post('searchtabledepcode', 'SearchTableController@searchdepcode')->name('searchtabledepcode');
Route::post('searchtableemail', 'SearchTableController@searchemail')->name('searchtableemail');
Route::post('searchtableposition', 'SearchTableController@searchposition')->name('searchtableposition');
Route::post('searchtablefrole', 'SearchTableController@searchrole')->name('searchtablerole');
//SOCIAL GROUPS
Route::resource('socgroupes', 'SocialchangeController');
Route::get('/', function () {
