...
class DiseaseListsController extends Controller
{
    ...
    {
        $dinisase= DiseaseList::where('status','active')->paginate(500);
        $dinisase_json = json_encode($dinisase);
        return  view('admin.dinisase.index', compact('dinisase','dinisase_json'));
