...
<ul class="c-sidebar-nav" style=" background-image: linear-gradient(#3F9D94, #2B6C65);">
    ...
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
        ...
        <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="{{route('sendreferals')}}">
                    Ուղարկված ուղեգրեր
                </a>
            </li>
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="{{route('resivedreferals')}}">
                    Ստացված ուղեգրեր
                </a>
            </li>
        </ul>
    ...
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link" href="{{ route("socgroupes.index") }}">
            <x-svg icon="cui-healing" sidebarIcon="true" />
            Սոցիալական խմբեր
        </a>
    </li>
