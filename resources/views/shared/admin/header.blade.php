<div class="c-wrapper">
    <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <ul class="c-header-nav ml-auto mr-4">
            <li class="c-header-nav-item mx-2 c-d-legacy-none">
                <button class="c-class-toggler c-header-nav-btn c-header-nav" onclick="btndark()"  type="button" id="header-tooltip" data-target="body"
    ...
    <script>
        function btndark(){
            localStorage.setItem('body',document.body.className);

            // document.getElementById("calendar_style").href = '/assets/calendar/css/evo-calendar-dark.css';
            // console.log(document.getElementById("calendar").getAttribute("href"));
        }

        if(localStorage.getItem("body")){
            document.body.className = localStorage.getItem("body");
        }
    </script>
