    ...
    <form action="{{ route('patients.store') }}" id="patient-create-form" class="ajax-submitable" method="POST">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="form-row">
                    <div class="form-group col-sm-12 col-md-4">
                        <label><b>Մարզ</b> &nbsp<input type="checkbox" onclick="myFunction()" id="myCheck"></label>
                        <input type="hidden" name="residence_region">
                        <div id="marz" style="display:none">
                            <x-forms.text-field name="residence_region" validationType="ajax" value="{{old('residence_region')}}" />
                        </div>
                    </div>
                    <div class="form-group col-sm-12 col-md-4">
            ...
            <li class="list-group-item">
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-12 col-md-4">
                        <label>Արյան խումբ</label>
                        <select name="blood_group" class="form-control" validationType="ajax">
                            <option @if(old('blood_group')==1) selected @endif value="1">0</option>
                            <option @if(old('blood_group')==2) selected @endif value="2">A</option>
                            <option @if(old('blood_group')==3) selected @endif value="3">B</option>
                            <option @if(old('blood_group')==4) selected @endif value="4">AB</option>
                        </select>
...
<script>
        ...
        function myFunction() {
            ...
            var text = document.getElementById("marz");
