...
<div class="container">
        ...
        <label for="intolerance"><strong>Դեղանյութերի կողմնակի ազդեցությունը (անտանելիությունը)՝</strong></label>
        <select style="width: 100px;display: inline-block" id="intolerance" name="intolerance" class="form-control" form="form1">
            <option value="0" @if ($stationary->intolerance == 0)
            selected @endif>Ոչ</option>
            <option value="1" @if ($stationary->intolerance == 1)
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <input name="area" class="form-control col-4" type="text" value="{{old('area', $stationary->area)}}">
...
<script>
    $(document).ready(function(){
        $(window).on('load',function(){
            if ($('#intolerance').val() == 1) {
                $('.intolerance').show()
            }else{
                $('.intolerance').hide()
            }
        })
        $('#intolerance').change(function(){
            if ($(this).val() == 1) {
                $('.intolerance').show()
            }else{
                $('.intolerance').hide()
