...
<div class="new-page">
    ...
    <div class="float-left">&nbsp;&nbsp;,Մարմնի մակերես</div>
    <div class="bottom-line float-left">{{$stationary->area ?? ""}} մ^2</div>
    ...
    <br><br>
    <div style="display: inline-block;" id="stationary_medicine_side_effect_intolerance">Դեղանյութերի կողմնակի ազդեցությունը(անտանելիությունը)</div>
    @if($stationary->intolerance == 1)
        <div style="display: inline-block;">Այո</div>
    @else
        <div style="display: inline-block;">Ոչ</div>
    @endif
