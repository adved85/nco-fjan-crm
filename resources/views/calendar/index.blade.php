...
@section('css')
    ...
    <link rel="stylesheet" href="{{asset('assets/calendar/css/evo-calendar.css')}}" id="calendar_link" />
...
@section('javascript')
    ...
    <script>
        var light = "/assets/calendar/css/evo-calendar.css";
        var dark = "/assets/calendar/css/evo-calendar-dark.css";

        function setStorage(key,value){
            localStorage.setItem(key,value);
        }

        document.getElementById("header-tooltip").onclick=()=>{
            if(localStorage.getItem('toggle') == "true"){
                document.getElementById("calendar_link").href= light;
                setStorage("calendar",light);
                setStorage("toggle","false");
            }else{
                document.getElementById("calendar_link").href= dark;
                setStorage("calendar",dark);
                setStorage("toggle","true");
            }
        }

        if(localStorage.getItem("calendar")){
            document.getElementById("calendar_link").href= localStorage.getItem("calendar");
        }
    </script>
